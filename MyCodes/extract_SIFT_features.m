% Returns a set of feature descriptors for a given set of key points. 
% 'x' and 'y' are x and y coordinates of key points.
% 'feature_width', in pixels, is the local feature width. 
% 'features' is the array of computed features. 128 for standard SIFT)
...
%------------------------------------------
function [calculatedFeatureList] = extract_SIFT_features(image, x, y, featureWidth)
